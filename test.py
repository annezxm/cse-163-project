...
def test_top_5(df):
    result = pj.top_5(df)
    result = result['rating'].values.tolist()
    expected = [93, 91, 83.5, 93.5, 29.5, 71, 92, 90.5, 83, 93, 28.5, 70, 90.5,
                91, 83.5, 93.5, 29.5, 70.5, 89.5, 91.5, 84, 93, 29.5, 70.5, 89,
                92, 84.5, 92.5, 33.5, 70, 88.5, 92.5, 87, 92.5, 37, 72, 87,
                92.5, 86, 92, 36.5, 71, 81.5, 92, 85, 90.5, 39, 73.5]
